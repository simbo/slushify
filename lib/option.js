...
Option.regexpName = /^[a-z0-9_]+$/i;

Option.isOption = function(option) {
    return option.constructor && option.constructor.name === 'Option' &&
        ...
        option.hasOwnProperty('name') && typeof option.name === 'string' && option.name.match(Option.regexpName) &&
